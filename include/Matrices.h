...
public:
    ...
    Matrix4&    lookAt(const Vector3& target);          // face object to the target direction
    Matrix4&    lookAt(const Vector3& target, const Vector3& up); // face object to target with up vector
